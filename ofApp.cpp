...
void ofApp::draw() {
	...
	for (int x = this->font_size * -5; x <= this->font_size * 5; x += this->font_size * 1.25)
	{
		for (int y = this->font_size * -5; y <= this->font_size * 5; y += this->font_size * 1.25) {
			...
			for (int outline_index = 0; outline_index < outline.size(); outline_index++) {
				...
				for (int vertices_index = 0; vertices_index < vertices.size(); vertices_index++) {
					...
					glm::vec3 vertex = glm::vec3(x - this->font_size * 0.5, y + this->font_size * 0.5, 0) + glm::vec3(vertices[vertices_index].x, vertices[vertices_index].y, vertices[vertices_index].z);
